    ...
    <Fragment>
      <li>
        <div className="relative block py-2 pl-3 pr-4 text-black rounded md:bg-transparent md:p-0">
          ...
          <div
            className={`absolute md:right-0 z-50 my-4 text-base list-none bg-bgColor divide-y divide-gray-100 rounded-lg shadow ${
    ...
    <nav className="bg-bgColor border-gray-200 relative z-10">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          ...
          id="navbar-default"
        >
          <ul className="flex flex-col md:items-center p-4 md:p-0 mt-4 border border-gray-100 bg-gray-50 md:flex-row md:text-black font-bold  md:space-x-8 md:mt-0 md:border-0 md:bg-bgColor dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ">
            {user ? (
              user.isAdmin ? (
                <>
                  <li>
